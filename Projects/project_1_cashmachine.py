...
def enter_pin():
    ...
    if used_attempts:
        ...
        type_writer("Your Balance is {}{}{} ".format(pound_sign,account_balance,pound_figures), MAGENTA, 0.03)
...
def cash_withdraw():
    ...
    while withdraw_amount < withdraw_limit:
        can_withdraw = True
        if can_withdraw:
            type_writer("Okay, Dispensing {}{}{}, Please Wait...\n".format(pound_sign,withdraw_amount,pound_figures), MAGENTA, 0.03)
            type_writer("Take Your Cash! \n", MAGENTA, 0.03)
            type_writer("Your Balance Is Now {}({}-{}){} ".format(pound_sign,account_balance,withdraw_amount,pound_figures), MAGENTA, 0.03)
            services()
    while withdraw_amount > withdraw_limit:
        can_withdraw = False
        if not(can_withdraw):
    
            type_writer("There Is Only {}{}{} Available In Your Account. ".format(pound_sign,account_balance,pound_figures), MAGENTA, 0.03)
    ...
    while withdraw_amount < 10: 
        ...
        if not(can_withdraw):
            ...
            type_writer("The Minimum Amount You Can Withdraw Is {}{}{} ".format(pound_sign,minimum_withdraw,pound_figures), MAGENTA, 0.03)
    
            type_writer("There Is {}{}{} Available In Your Account. ".format(pound_sign,account_balance,pound_figures), MAGENTA, 0.03)
            cash_withdraw()
    services()

def check_account():
    type_writer("Checking Your Account Details, Please Wait... \n", MAGENTA, 0.03)
    type_writer("Account Number: {}".format(account_number), MAGENTA, 0.03)
    type_writer("Account Name: {}".format(account_name), MAGENTA, 0.03)
    type_writer("Account Balance: {}{}{}".format(pound_sign,account_balance,pound_figures), MAGENTA, 0.03)
